...
button.addEventListener('click', function (e) {
  ...
  var className = this.classList.value;
...
function modal() {
  ...
  console.log(options);
  var openModalTriggerElement = document.querySelector(options.triggerElementSelector);
  var modalElement = document.querySelector(options.selector);
...
var input = document.querySelector('.add-content-modal');
