...
var d = [1, 2, 1, 87, 54, 14, 1, 54, 15, 5, 1, 58, 1, 45, 8, 4, 56, 88, 2];
...
function spliceIndexofArray() {
  ...
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      ...
      data.splice(value, 1, (_replaseArray$i = replaseArray[i]) !== null && _replaseArray$i !== void 0 ? _replaseArray$i : deafaultReplase);
      i++;
    }
  } catch (err) {
    _iterator.e(err);
