...
var emptyString = '';
var markHash = '#';
for (var i = 0; askNumber1Hash > i; i++) {
  for (var j = 0; j <= i; j++) {
...
var finalOutput = '';
for (var _i = 1; _i <= askNumber2Hash; _i++) {
  var _emptyString = ' '.repeat(askNumber2Hash - _i);
  var _markHash = '#'.repeat(_i);
  finalOutput += _emptyString + _markHash + '\n';
}
