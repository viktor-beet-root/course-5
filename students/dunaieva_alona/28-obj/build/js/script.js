...
var inList = ' is in the list';
var notList = 'not in the list';
var driverSearch = 'Ivan';
...
function getTimeAndFuel(distance) {
  var breakDriver = 1;
  var fullTravelTime = (distance / autoProfile.averageSpeed).toFixed(1);
  var qtyFuel = distance / 100 * autoProfile.averageFuelConsumptionPer100Km;
  if (fullTravelTime >= 4) {
