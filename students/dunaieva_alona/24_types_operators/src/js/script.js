...
const textNumbersOfFiles = 'Nunbers of files: ';
console.log(textNumbersOfFiles  +  parseInt(numberOfFiles));
...
const textNumberChocolate = 'Number of chocolate: ';
console.log(textNumberChocolate +  numberOfChocolates);

const cash = (askMoney - numberOfChocolates * askPriceСhocolates);
const textBalance = 'Fund balance: ';
console.log(textBalance + cash.toFixed(2));
...
const textPercent = 'Amount of accrued annual interest: ';
console.log(textPercent + ((askDeposit * (percentDeposit / 12)) * 2).toFixed(2));
