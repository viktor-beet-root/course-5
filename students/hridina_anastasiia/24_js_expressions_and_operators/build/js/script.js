...
/* harmony import */ var core_js_modules_es_number_max_safe_integer_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.number.max-safe-integer.js */ "./node_modules/core-js/modules/es.number.max-safe-integer.js");
/* harmony import */ var core_js_modules_es_number_max_safe_integer_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_number_max_safe_integer_js__WEBPACK_IMPORTED_MODULE_0__);
...
//number
var num = (2, 2.5, -1, 0, -0, Infinity, -Infinity, NaN);
console.log(NaN === NaN);
console.log(2 + '2');
console.log(isNaN(NaN));
console.log((0.1 * 10 + 0.2 * 10) / 10);
console.log(Number.MAX_SAFE_INTEGER);
console.log(_typeof(2.3456456465.toFixed(2)));
...
// String
var string = ('hg"jgj"g', "g'f  2\" dg'j", "");
console.log("g'f  2\" <br>" + "\\n dg'j");
console.log("g'f  2\" <br> \
    \\n dg'j");
var n = 'test';
console.log("\n".concat(n + 'jnsfsk', "\n").concat((2 + 2).toFixed(2), "\nsdfdf\nsdfdfs\n''\n\"\"\nsdfcv\n"));
var f = 'sddd';
f = f + 'a';
...
var typeSymbol = Symbol('sfgbs');

//Обʼєктні типи, що змінюються

var arr = [0, 1, 0, 1, 1, '', {}, [], function () {}, null, undefined]; //упорядкований список нумерованих значень
arr[0] = 1;
//[[1,0,0],[1,2,0],[1,0,0]]
console.log(arr);
var obj = {
  ...
  b: 21,
  2: 2
}; // неупорядкований список іменованих значень
obj.age = 30;
console.log(obj);
...
var flashCard = +prompt('Please enter the storage of your memory card in GB', '');
var oneFile = 820;
var amount = flashCard * 1000 / oneFile;
...
var sumOfMoney = +prompt('Please enter the amount of money you have in cash', '');
var oneBarPrice = +prompt('Please enter the price of one chocolate bar', '');
var amountOfBars = Math.round(sumOfMoney / oneBarPrice);
var change = (sumOfMoney % amountOfBars).toFixed(2);
var result = 'You can buy' + ' ' + amountOfBars + ' ' + 'chocolate bars.' + ' ' + 'Your change is' + ' ' + change;
console.log(result);
...
var firstN = number % 10;
var secondN = ~~(number / 10) % 10;
var thirdN = ~~(number / 100) % 10;
var isResult = firstN + '' + secondN + '' + thirdN;
...
var depositSum = +prompt('Please enter a deposit amount', '');
var depositPercentage = 5;
var percentPerMonth = depositPercentage / 12;
var percentPerTwoMonths = percentPerMonth * 2;
