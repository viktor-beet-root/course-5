...
function timeAndFuelAmount(distance) {
  var time = distance / automobileList.averageSpeed;
  var timeWithBreaks = time / 4 * 1;
  var totalTime = time + timeWithBreaks;
  var fuelAmountNeeded = distance * automobileList.averageFuelConsumption / 100;
