...
/* harmony import */ var lightbox2__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! lightbox2 */ "./node_modules/lightbox2/dist/js/lightbox.js");
/* harmony import */ var lightbox2__WEBPACK_IMPORTED_MODULE_16___default = /*#__PURE__*/__webpack_require__.n(lightbox2__WEBPACK_IMPORTED_MODULE_16__);
...
jquery__WEBPACK_IMPORTED_MODULE_14___default()('.hero-slider').slick({
  dots: true,
  vertical: true,
  slidesToShow: 1,
  slidesToScroll: 1,
...
jquery__WEBPACK_IMPORTED_MODULE_14___default()('.news__row').slick({
  slidesToShow: 3,
  slidesToScroll: 1,
  dots: true,
  arrows: true,
...
// burger menu
var menu = jquery__WEBPACK_IMPORTED_MODULE_14___default()('.menu__list');
...
jquery__WEBPACK_IMPORTED_MODULE_14___default()('.menu-open-btn').on('click', function (e) {
  e.preventDefault();
  if (!isOpenMenu) {
    menu.css({
      display: 'flex'
    ...
    setTimeout(function () {
      jquery__WEBPACK_IMPORTED_MODULE_14___default()(this).closest('.menu').toggleClass('_open', !isOpenMenu);
      isOpenMenu = true;
    }.bind(this), 0);
    return;
  }
...
// bg-menu-scroll
var header = jquery__WEBPACK_IMPORTED_MODULE_14___default()('.header');
...
// scroll to top
var body = jquery__WEBPACK_IMPORTED_MODULE_14___default()("html, body");
...
function scrollToTop(_ref, observer) {
...
;
var observerScroll = new IntersectionObserver(scrollToTop, optionsScroll);
var scrollTarget = document.querySelector('.footer');
observerScroll.observe(scrollTarget);
jquery__WEBPACK_IMPORTED_MODULE_14___default()('.scroll-to-top').on('click', function (e) {
  e.preventDefault();
  body.stop().animate({
    scrollTop: 0
  }, 200);
...
var closeGallery = document.getElementById('closeGalleryBtn');
var galleryItem = document.querySelector('.gallery__item');
...
jquery__WEBPACK_IMPORTED_MODULE_14___default()('openGalleryBtn').on('click', function () {
