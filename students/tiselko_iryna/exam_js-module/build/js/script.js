...
jquery__WEBPACK_IMPORTED_MODULE_3___default()('.news__row').slick({
  slidesToShow: 3,
  slidesToScroll: 1,
  dots: true,
  arrows: true,
...
// burger menu
var menu = jquery__WEBPACK_IMPORTED_MODULE_3___default()('.menu__list');
...
jquery__WEBPACK_IMPORTED_MODULE_3___default()('.menu-open-btn').on('click', function (e) {
  ...
  if (!isOpenMenu) {
    ...
    setTimeout(function () {
      jquery__WEBPACK_IMPORTED_MODULE_3___default()(this).closest('.menu').toggleClass('_open', !isOpenMenu);
      isOpenMenu = true;
    }.bind(this), 0);
    return;
  }
...
var secondSectionOffset = jquery__WEBPACK_IMPORTED_MODULE_3___default()('.about').offset().top;
var offset = 20;
