...
/* harmony import */ var just_validate__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! just-validate */ "./node_modules/just-validate/dist/just-validate.es.js");
...
/* harmony import */ var _fancyapps_ui__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! @fancyapps/ui */ "./node_modules/@fancyapps/ui/dist/index.esm.js");
...
var body = jquery__WEBPACK_IMPORTED_MODULE_15___default()("html, body");
_fancyapps_ui__WEBPACK_IMPORTED_MODULE_18__.Fancybox.bind();
jquery__WEBPACK_IMPORTED_MODULE_15___default()('.hero-slider').slick({
  dots: true,
  vertical: true,
  slidesToShow: 1,
  slidesToScroll: 1,
...
// burger menu
var menu = jquery__WEBPACK_IMPORTED_MODULE_15___default()('.menu__list');
...
jquery__WEBPACK_IMPORTED_MODULE_15___default()('.menu-open-btn').on('click', function (e) {
  e.preventDefault();
  if (!isOpenMenu) {
    menu.css({
      display: 'flex'
    ...
    setTimeout(function () {
      jquery__WEBPACK_IMPORTED_MODULE_15___default()(this).closest('.menu').toggleClass('_open', !isOpenMenu);
      isOpenMenu = true;
    }.bind(this), 0);
    return;
  }
...
// bg-menu-scroll
var header = jquery__WEBPACK_IMPORTED_MODULE_15___default()('.header');
...
function smoothScrollMenu() {
  jquery__WEBPACK_IMPORTED_MODULE_15___default()('.menu__link').on('click', function (e) {
    e.preventDefault();
    var switchToSection = jquery__WEBPACK_IMPORTED_MODULE_15___default()(this).attr('href');
    body.animate({
      scrollTop: jquery__WEBPACK_IMPORTED_MODULE_15___default()(switchToSection).offset().top
    }, 1000);
  });
}
smoothScrollMenu();
...
function smoothScrollDown() {
  jquery__WEBPACK_IMPORTED_MODULE_15___default()('.smoothScrollDown__link').on('click', function (e) {
    e.preventDefault();
    var ScrollDown = jquery__WEBPACK_IMPORTED_MODULE_15___default()(this).attr('href');
    body.animate({
      scrollTop: jquery__WEBPACK_IMPORTED_MODULE_15___default()(ScrollDown).offset().top
    }, 1000);
  });
}
smoothScrollDown();
...
var scrollToTop = function scrollToTop(entries, scrollObserver) {
  entries.forEach(function (entry) {
    if (entry.isIntersecting) {
      scrollToTopBtn.style.display = 'none';
      jquery__WEBPACK_IMPORTED_MODULE_15___default()('.scroll-to-top').on('click', function (e) {
        e.preventDefault();
        body.stop().animate({
          scrollTop: 0
        }, 800);
...
var scrollObserver = new IntersectionObserver(scrollToTop, optionsScroll);
var scrollTarget = document.querySelector('.hero');
scrollObserver.observe(scrollTarget);

// galleryBtn
var openGalleryBtn = document.getElementById('openGalleryBtn');
var images = document.querySelectorAll('.item_hidden');
var isHidden = true;
openGalleryBtn.addEventListener('click', function (e) {
  ...
  if (isHidden) {
    ...
    images.forEach(function (item) {
      return item.classList.add('_hidden');
    });
  }
...
//form-validation
var getInTouchForm = document.getElementById('contacts-form');
function contactFormValidation(form) {
  var validator = new just_validate__WEBPACK_IMPORTED_MODULE_16__["default"](form, getUserData);
...
// gallery
var imgBig = document.querySelectorAll('.xxs');
function addStyletoImg() {
  if (mediaQueryImgBig.matches) {
    imgBig.forEach(function (item) {
      return item.classList.add('-big');
    });
  } else {
    imgBig.forEach(function (item) {
      return item.classList.remove('-big');
    });
  }
}
var mediaQueryImgBig = window.matchMedia("(max-width: 480px)");
