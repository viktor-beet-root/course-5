...
//String
var string = ("dfh'vzxxc 2\" dv'fsgh", 'gsagg', "batkiki");
...
//
var typyNull = null; //потрiбно завжди присваювати

var typeBool = true; //1
typeBool = false; //0

//
var typeSymbol = Symbol('sfdfdfg'); //для роботи з об`эктом

//Об'єктні типи, що змінюються

var arr = [1, 0, 1, 1, 1, '', {}, [], function () {}, null, underfined]; //масив це список
arr[0] = [1];
// [[1, 0, 0], [1, 2, 0], [1, 0, 0]]
console.log(arr);
var obj = {
...
console.log( true && 0); // це і - спотикаеться на лжи
