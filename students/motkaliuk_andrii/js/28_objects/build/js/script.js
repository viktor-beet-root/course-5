...
var obj = (_obj = {
  ...
  age: 26,
  skillList: []
}, _defineProperty(_obj, "skillList", {}), _defineProperty(_obj, 'random skill', 'skill'), _obj);
...
function copyObj(obj) {
  ...
  for (var _key in obj) {
    ...
    if (obj.hasOwnProperty(_key)) newObj[_key] = _typeof(obj[_key]) === 'object' ? copyObj(obj[_key]) : obj[_key];
  }
  return newObj;
}
...
var petro = createUser({
  userName: 'Petro',
  age: 26
});
vasya.setAge(35);
petro.setAge(35);
var userPetro = petro.userName,
  _petro$age = petro.age,
  age = _petro$age === void 0 ? 50 : _petro$age;
