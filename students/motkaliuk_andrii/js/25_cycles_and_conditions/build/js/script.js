...
var yourAgeString = prompt('Your age?');
var yourAge = Number(yourAgeString);
if (isNaN(yourAge)) {
...
var inp = prompt('Input 5-dig number');
if (inp.length !== 5) {
  console.log('Rewrite. Incorrect data');
} else {
  var _number = parseInt(inp);
  var digit1 = Math.floor(_number / 10000);
  var digit2 = Math.floor(_number % 10000 / 1000);
  var digit3 = Math.floor(_number % 1000 / 100);
  var digit4 = Math.floor(_number % 100 / 10);
  var digit5 = _number % 10;
...
var evenCount = 0;
var oddCount = 0;
for (var _i2 = 0; _i2 < totalNumbers; _i2++) {
  var _number2 = parseFloat(prompt('Введіть число ' + (_i2 + 1)));
  if (isNaN(_number2)) {
...
var dayOfWeek = 0;
while (true) {
  var userResponse = confirm("".concat(days[dayOfWeek], ". \u0425\u043E\u0447\u0435\u0448 \u043F\u043E\u0431\u0430\u0447\u0438\u0442\u0438 \u043D\u0430\u0441\u0442\u0443\u043F\u043D\u0438\u0439 \u0434\u0435\u043D\u044C?"));
  if (!userResponse) {
    break;
  }
...
var piramid2 = 5;
var result2 = '';
for (var _i4 = 1; _i4 <= piramid2; _i4++) {
  var spaces = '';
  var hashes = '';
  for (var _j = 1; _j <= piramid2 - _i4; _j++) {
    spaces += ' ';
  }
  for (var k = 1; k <= _i4; k++) {
    hashes += '#';
