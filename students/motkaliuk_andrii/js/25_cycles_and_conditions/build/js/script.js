...
if (inp.length !== 5) {
  ...
  var dig = inp.split("");
  var reversedInp = dig.slice().reverse();
  var polidrom = true;
  for (var _i = 0; _i < dig.length; _i++) {
    if (dig[_i] !== reversedInp[_i]) {
      polidrom = false;
      break;
    }
  }
...
var evenCount = 0,
  oddCount = 0;
var input = prompt("\u0412\u0432\u0435\u0434\u0456\u0442\u044C 10 \u0447\u0438\u0441\u0435\u043B, \u0440\u043E\u0437\u0434\u0456\u043B\u0435\u043D\u0438\u0445 \u043A\u043E\u043C\u0430\u043C\u0438:");
var numbers = input.split(/[,]+/).map(Number);
var _iterator = _createForOfIteratorHelper(numbers),
  _step;
try {
  for (_iterator.s(); !(_step = _iterator.n()).done;) {
    var _number = _step.value;
    if (_number > 0) {
      positiveCount++;
      if (_number % 2 === 0) {
        evenCount++;
...
console.log(input);
console.log("\u0414\u043E\u0434\u0430\u0442\u043D\u0456: ".concat(positiveCount));
console.log("\u0412\u0456\u0434\u2019\u0454\u043C\u043D\u0456: ".concat(negativeCount));
console.log("\u041D\u0443\u043B\u0456: ".concat(zeroCount));
console.log("\u041F\u0430\u0440\u043D\u0456: ".concat(evenCount));
console.log("\u041D\u0435\u043F\u0430\u0440\u043D\u0456: ".concat(oddCount));
...
var piramid2 = 5;
for (var _i3 = 1; _i3 <= piramid2; _i3++) {
  var spaces = '';
  var hashes = '';
  for (var _j = 1; _j <= piramid2 - _i3; _j++) {
    spaces += ' ';
  }
  for (var k = 1; k <= _i3; k++) {
    hashes += '#';
