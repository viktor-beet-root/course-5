...
var purchaseList = [createPurchase("milk", 2, false, 25), createPurchase("bread", 1, true, 15), createPurchase("eggs", 12, true, 3), createPurchase("fruit", 5, false, 10)];
...
function setPurchaseStatus(list, productName) {
  var purchase = list.find(function (item) {
    return item.purchName === productName;
  });
  if (purchase) {
...
function deletePurchaseItem(list, itemName) {
  return list.filter(function (item) {
    return item.purchName !== itemName;
  });
}
function addNewPurchase(list, newPurchName, newQuantity, price) {
  var existingPurchase = list.find(function (item) {
    return item.purchName === newPurchName;
  });
  if (existingPurchase) {
    ...
    var newPurchase = createPurchase(newPurchName, newQuantity, false, price);
...
var editedPurchaseList = deletePurchaseItem(purchaseList, 'eggs');
