            ...
            <div className="weather-forecast__title_wrapper ">
                <div className="weather-forecast lisabon">
                    ...
                    <div className="weather weather__half clear-fix">
                        ...
                        {/* <img src={"images/icon_1.svg"} alt="weather forecast icon" className="weather-forecast__img"> */}
                    </div>
                </div>
                <div class="weather-forecast paris">
                    <h3 className="weather-forecast__city ">Paris</h3>
                    <div className="weather clear-fix">
                        <p className="weather-forecast__temp">11°C</p>
                        {/* <img src="images/icon_2.svg" alt="weather forecast icon" className="weather-forecast__img"> */}
                    </div>
                </div>
                <div className="weather-forecast belgrade">
                    ...
                    <div className="weather clear-fix">
                        ...
                        {/* <img src="images/icon_3.svg" alt="weather forecast icon" className="weather-forecast__img"> */}
                    </div>
                </div>
                <div className="weather-forecast venice">
                    ...
                    <div className="weather clear-fix">
                        <p className="weather-forecast__temp">21°C</p>
                        {/* <img src="images/icon_4.svg" alt="weather forecast icon" className="weather-forecast__img"> */}
                    </div>
                </div>
                <div className="weather-forecast tel-avive">
                    ...
                    <div className="weather clear-fix">
                        ...
                        {/* <img src="images/icon_5.svg" alt="weather forecast icon" className="weather-forecast__img"> */}
                    </div>
                </div>
                <div className="weather-forecast cair">
                    ...
                    <div className="weather clear-fix">
                        <p className="weather-forecast__temp">21°C</p>
                        {/* <img src="images/icon.svg" alt="weather forecast icon" className="weather-forecast__img"> */}
                    </div>
                </div>
                <div className="weather-forecast new-york">
                    ...
                    <div className="weather clear-fix">
                        ...
                        {/* <img src="images/icon_6.svg" alt="weather forecast icon" className="weather-forecast__img"> */}
                    </div>
                </div>
                <div className="weather-forecast new-delhi">
                    ...
                    <div className="weather clear-fix">
                        <p className="weather-forecast__temp">17°C</p>
                        {/* <img src="images/icon_10.svg" alt="weather forecast icon" className="weather-forecast__img"> */}
                    </div>
                </div>
                <div className="weather-forecast san-francisco">
                    ...
                    <div className="weather weather__half clear-fix">
                        <p className="weather-forecast__temp">15°C</p>
                        {/* <img src="images/icon_9.svg" alt="weather forecast icon" className="weather-forecast__img"> */}
                    </div>
                </div>
                <div className="weather-forecast tokyo">
                    ...
                    <div className="weather clear-fix">
                        ...
                        {/* <img src="images/icon_7.svg" alt="weather forecast icon" className="weather-forecast__img"> */}
                    </div>
                </div>
                <div className="weather-forecast sydney">
                    ...
                    <div className="weather weather__full  clear-fix">
                        ...
                        {/* <img src="images/icon_8.svg" alt="weather forecast icon" className="weather-forecast__img"> */}
                    </div>
                </div>
            </div>
