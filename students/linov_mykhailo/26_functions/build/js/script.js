...
function factorial(number) {
  if (number < 0 || isNaN(number)) {
    ...
    var factorialNumber = number * factorial(number - 1);
...
function threeNumbers(num1, num2, num3) {
  if (isNaN(num1) || isNaN(num2) || isNaN(num3) || num1 < 0 || num2 < 0 || num3 < 0) {
    ...
    var numberString1 = num1.toString();
    var numberString2 = num2.toString();
    var numberString3 = num3.toString();
    var finalNumber = Number(numberString1 + numberString2 + numberString3);
    return finalNumber;
  }
}
