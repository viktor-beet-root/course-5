...
var car = {
  ...
  informationAboutCar: function informationAboutCar() {
  ...
  addDriver: function addDriver(newDriver) {
    return this.drivers = this.drivers + ", " + newDriver;
  },
  isDriverInList: function isDriverInList(driverName) {
  ...
  howMuchTimeItTakes: function howMuchTimeItTakes(distance) {
    var averageSpeed = this.averageSpeed;
    var fuelConsumption = this.fuelConsumption;
    var breakInterval = 4;
    var breakTime = 1;
    var numberOfSegments = Math.ceil(distance / (averageSpeed * breakInterval));
    var timeOnFullSegments = distance / averageSpeed + (numberOfSegments - 1) * breakTime;
    var totalFuelConsumption = fuelConsumption / 100 * distance;
    var timeNeeded = timeOnFullSegments.toFixed(2);
    var fuelNeeded = totalFuelConsumption.toFixed(2);
...
function addSeconds(secondsAdd) {
  var totalSeconds = timeObject.hours * 3600 + timeObject.seconds * 60 + timeObject.seconds + secondsAdd;
  var newHours = Math.floor(totalSeconds / 3600) % 24;
...
function addMinutes(minutesAdd) {
  var totalMinutes = timeObject.hours * 60 + timeObject.minutes + minutesAdd;
...
function addHours(hoursAdd) {
  var totalHours = timeObject.hours + hoursAdd;
