...
var sumOfTwoNumbers = (firstNumber * 10 + secondNumber * 10) / 10;
...
var string = '1';
var number = 2;
var sumOfStringAndNumber = (+string * 10 + number * 10) / 10;
...
var objectSize = 0.82;
var userGigabytes = prompt('Please enter size of your flash drive in GB');
var quantityOfFilesThatFitOnFlashDrive = Math.floor(userGigabytes / objectSize);
...
var userMoney = prompt("Please enter amount of your money");
var chocolatePrice = prompt("Now please enter the cost of the chocolate bar");
var chocolateQuantity = Math.floor(userMoney / chocolatePrice);
var whatRemains = (userMoney - chocolateQuantity * chocolatePrice).toFixed(2);
...
var hundreds = userNumber % 10 * 100;
var tens = ~~(userNumber / 10) % 10 * 10;
var singles = ~~(userNumber / 100);
var reverseUserNumber = hundreds + tens + singles;
