...
var a = users.find(function (user /*, index, arr*/) {
  console.log(user);
...
function cart() {
  ...
  return {
    ...
    setQty: function setQty(sku, qty, index) {
      var indexProductSku = index !== null && index !== void 0 ? index : this.findIndexBySku(sku);
      if (indexProductSku != -1) {
    ...
    getTotalQty: function getTotalQty() {
      var totalQty = cart.reduce(function (acc, curQty) {
        return acc + curQty.qty;
      }, 0);
      return totalQty;
    },
    getTotal: function getTotal() {
      var totalPrice = cart.reduce(function (acc, curProd) {
        return acc + curProd.qty * curProd.price;
      }, 0);
      return totalPrice;
    },
    getProductBySku: function getProductBySku(sku) {
      //find
      var p = cart.find(function (product) {
