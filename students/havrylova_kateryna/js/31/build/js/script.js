...
var menuItems = _toConsumableArray(nav.querySelectorAll('.menu > li'));
...
console.log(_toConsumableArray(menuItems)); //колекцію передає в масив
...
function isNodeElem(elem) {
  return _typeof(elem) === 'object' && elem.nodeType === 1;
}
