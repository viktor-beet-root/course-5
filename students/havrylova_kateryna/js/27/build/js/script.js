...
console.log(user.skillList);
for (var _key in obj) {
  console.log(_key); //виводимо властивості
}

for (var _key2 in user) {
  console.log(user[_key2]); //виводимо значення властивостей
}

obj.sss = "error"; //added new властивість обʼєкта

for (var _key3 in obj) {
  console.log(_key3, obj[_key3]);
}
...
var objCopy = Object.assign({}, obj, {
  age: 300
}); //всі обʼєкти обʼєднуюится по черзі - до пустого додаємо існуючого, але це поверхневе копіювання
objCopy.age = 100;
// console.log(obj, objCopy);
// objCopy.age = 120;

var objCopySecond = _objectSpread(_objectSpread({}, obj), {}, {
...
var objCopyThird = JSON.parse(JSON.stringify(obj));
...
function copyObj(obj) {
  ...
  for (var _key4 in obj) {
    ...
    if (obj.hasOwnProperty(_key4)) {
      newObj[_key4] = _typeof(obj[_key4]) === "object" ? copyObj(obj[_key4]) : obj[_key4];
    }
  }
  return newObj;
}
...
function setAge(age) {
  if (!age && age !== 0 || typeof age !== 'number' || age < 0) return;
  this.age = age;
}
...
var vasya = createUser({
  userName: "Vasya"
  // age: 30,
});

var petya = createUser({
  userName: "Petya",
  age: 20
});
...
var userName = 'sdhgfj';
var userPetya = petya.userName,
  _petya$age = petya.age,
  age = _petya$age === void 0 ? 50 : _petya$age;
