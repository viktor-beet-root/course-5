...
var arr = [100, 32, 1, 25, 3, 5, 585]; //додали значення
var arr1 = Array(10); //створили массив з 100 значеннями
...
console.log(arr);
var d = [1, 2, 5, 2, 5, 1, 87, 54, 34, 1, 78, 99, 1, 23, 64, 16, 76, 32, 7, 59];
var oddArr = [];
var evenArr = [];
for (var _i = 0, _d = d; _i < _d.length; _i++) {
  ...
  if (value % 2 == 0) {
    ...
    oddArr.push(value);
    for (var _i2 = 0; _i2 < oddArr.length; _i2++) {
      for (var _j = _i2 + 1; _j < oddArr.length; _j++) {
        if (oddArr[_i2] == oddArr[_j]) {
          oddArr.pop();
        }
      }
    }
...
var newArr = [];
var tmpArr = [];
for (var _i3 = 0, _d2 = d; _i3 < _d2.length; _i3++) {
  var _value = _d2[_i3];
  if (!tmpArr[_value]) {
    newArr.push(_value);
    tmpArr[_value] = true;
...
console.log(newArr);
var copyArr = [].concat(d);
var copyArr1 = d.concat(); //copy array
var copyArr2 = d.concat('d'); //copy array + new element

copyArr[0] = 1111;
console.log(copyArr, d);
var copyArr3 = d.slice(); //copy array 
var copyArr4 = d.slice(5, 10); //copy array from 5 to (10-1) elements
...
function getIndexOf() {
  ...
  var findData = arguments.length > 1 ? arguments[1] : undefined;
  var findIndex = [];
  var index = data.indexOf(findData);
  while (index !== -1) {
...
function spliceIndexOfArray() {
  var data = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
  var indexArray = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];
  var replaceArray = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : [];
  var isMutation = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;
  if (isMutation) data = _toConsumableArray(data);
  var defaultReplace = 0;
  var i = 0;
  var _iterator = _createForOfIteratorHelper(indexArray),
    _step;
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      ...
      console.log(_value2);
      data.splice(_value2, 1, (_replaceArray$i = replaceArray[i]) !== null && _replaceArray$i !== void 0 ? _replaceArray$i : defaultReplace); //del by index
      i++;
    }
  } catch (err) {
    _iterator.e(err);
...
var first = number[0],
  second = number[1],
  _number$ = number[6],
  sss = _number$ === void 0 ? 55 : _number$;
console.log(first, second, sss);
var first1 = number[0],
  second1 = number[1],
  other = number.slice(2);
