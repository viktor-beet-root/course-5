...
/* harmony import */ var _vars_variables_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./vars/variables.js */ "./src/js/vars/variables.js");
...
/* harmony import */ var _vars_variables_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../vars/variables.js */ "./src/js/vars/variables.js");
...
function changeSpeakers(addStudentForm) {
  ...
  function renderSpeaker() {
    ...
    if (speaker && _authors_js__WEBPACK_IMPORTED_MODULE_2__["default"][speaker]) {
      ...
      img.setAttribute('src', _vars_variables_js__WEBPACK_IMPORTED_MODULE_3__.imgPath + _authors_js__WEBPACK_IMPORTED_MODULE_2__["default"][speaker].img);
...
/***/ "./src/js/formValidation/createFormValidation.js":
/*!*******************************************************!*\
  !*** ./src/js/formValidation/createFormValidation.js ***!
  \*******************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
function createFormValidation(form, createCourseFn) {
  var validator = new just_validate__WEBPACK_IMPORTED_MODULE_0__["default"](form, undefined, _dict_js__WEBPACK_IMPORTED_MODULE_2__["default"]);
...
var dict = [{
  ...
  key: 'The field contain',
  dict: {
    uk: 'В полі має бути 2 символи'
  }
}];
...
/* harmony import */ var _addStudent_js__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./addStudent.js */ "./src/js/addStudent.js");
...
/* harmony import */ var _formValidation_changeSpeakers_js__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./formValidation/changeSpeakers.js */ "./src/js/formValidation/changeSpeakers.js");
/* harmony import */ var _formValidation_createFormValidation_js__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./formValidation/createFormValidation.js */ "./src/js/formValidation/createFormValidation.js");
/* harmony import */ var _vars_variables_js__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./vars/variables.js */ "./src/js/vars/variables.js");
...
var courseList = [];
var courseId = 0;
(0,_formValidation_changeSpeakers_js__WEBPACK_IMPORTED_MODULE_17__["default"])(addStudentForm);
(0,_formValidation_createFormValidation_js__WEBPACK_IMPORTED_MODULE_18__["default"])(addStudentForm, createCourse);
...
courseListElement.addEventListener('click', function (e) {
  var addStudentBtn = e.target.closest(".".concat(_vars_variables_js__WEBPACK_IMPORTED_MODULE_19__.addStudentClassName));
  var removeCourseBtn = e.target.closest(".".concat(_vars_variables_js__WEBPACK_IMPORTED_MODULE_19__.removeCourseClassName));
  if (addStudentBtn) {
...
function removeCuorse(removeCourseBtn) {
  var courseId = getDataAttrIdCourse(removeCourseBtn);
...
function addStudents(addStudentBtn) {
  ...
  var studentHtml = (0,_addStudent_js__WEBPACK_IMPORTED_MODULE_15__["default"])(student, course.studentList.length - 1, courseId);
...
/******/ 	__webpack_require__("./src/js/formValidation/changeSpeakers.js");
/******/ 	__webpack_require__("./src/js/formValidation/createFormValidation.js");
/******/ 	__webpack_require__("./src/js/formValidation/dict.js");
/******/ 	var __webpack_exports__ = __webpack_require__("./src/js/vars/variables.js");
/******/ 	
/******/ })()
;
