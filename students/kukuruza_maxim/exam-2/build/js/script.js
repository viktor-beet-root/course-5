...
var galleryBtn = document.querySelector('#button');
...
/* harmony default export */ __webpack_exports__["default"] = (galleryBtn);
...
/* harmony import */ var _navMenu__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./navMenu */ "./src/js/navMenu.js");
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.slider__items').slick({
  vertical: true,
  infinite: true,
  slidesToShow: 1,
  slidesToScroll: 1,
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.lt-news__carousel').slick({
  infinite: true,
  arrows: true,
  arrowsClass: "arr",
  slidesToShow: 3,
  ...
  dots: true,
  dotsClass: "dot",
  appendDots: jquery__WEBPACK_IMPORTED_MODULE_0___default()('.dots'),
  rows: 0,
  responsive: [{
    breakpoint: 1200,
    settings: {
...
window.lightbox = (lightbox2__WEBPACK_IMPORTED_MODULE_3___default());
...
var menu = jquery__WEBPACK_IMPORTED_MODULE_1___default()('.menu__nav');
...
jquery__WEBPACK_IMPORTED_MODULE_1___default()('.menu-click').on('click', function (e) {
  e.preventDefault();
  if (!isOpenMenu) {
    menu.css({
      display: 'flex'
...
var showError = function showError(input, message) {
  ...
  var formLabel = input.parentElement;
  // add the error class
  formLabel.classList.remove('success');
  formLabel.classList.add('error');

  // show the error message
  var error = formLabel.querySelector('small');
...
var checkUsername = function checkUsername() {
  ...
  if (!isRequired(username)) {
    ...
    showError(usernameEl, "Username must be between ".concat(min, " and ").concat(max, " characters."));
  } else {
...
form.addEventListener('submit', function (e) {
  ...
  var isFormValid = isUsernameValid && isEmailValid;
});
...
/******/ 	__webpack_require__("./src/js/carousel.js");
/******/ 	// This entry module is referenced by other modules so it can't be inlined
/******/ 	__webpack_require__("./src/js/gallery.js");
/******/ 	__webpack_require__("./src/js/navMenu.js");
/******/ 	__webpack_require__("./src/js/script.js");
/******/ 	__webpack_require__("./src/js/sidebar.js");
/******/ 	__webpack_require__("./src/js/slider.js");
/******/ 	var __webpack_exports__ = __webpack_require__("./src/js/validationForm.js");
/******/ 	
/******/ })()
;
